...
export default function OneOnOne() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="mt-3 text-3xl font-extrabold">Single 1:1 Session</h1>
      <div className="mt-2 text-neutral-600">$120</div>

      <p className="mt-5 text-neutral-700">
        Targeted skill boost with high-rep technical work and micro-corrections.
        Position-specific patterns available.
      </p>

      <div className="mt-6">
        <h2 className="font-semibold text-lg">What’s included</h2>
        <ul className="mt-2 list-disc pl-5 space-y-1 text-neutral-700">
          <li>60–75 min session</li>
          <li>Position-specific tactics</li>
          <li>Take-home drills</li>
        </ul>
      </div>
