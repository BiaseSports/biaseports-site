...
export default function BasicPlan() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="mt-3 text-3xl font-extrabold">Basic (Monthly)</h1>
  ...
  <strong> game observation</strong>.
      ...
      <div className="mt-6">
        ...
        <ul className="mt-2 list-disc pl-5 space-y-1 text-neutral-700">
          <li>Weekly training (higher intensity than Starter)</li>
          <li>Position-specific patterns & decision-making</li>
          <li>Filmable reps for feedback</li>
          <li>Updated action plan each month</li>
        </ul>
      </div>
      ...
      <section className="mt-10 rounded-2xl border border-neutral-200 p-5">
        ...
        <p className="mt-2 text-neutral-700">
          You can pay via <strong>Zelle</strong> or <strong>Venmo</strong>. Please
          include the player’s name in the memo.
        </p>
        ...
        <p className="mt-4 text-sm text-neutral-600">
          <strong>Important:</strong> Training is <u>not reserved</u> until
          payment is received. Please complete the Player Info form after payment.
        </p>
      </section>
