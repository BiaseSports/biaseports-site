...
export default function FilmSession() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="mt-3 text-3xl font-extrabold">Film Session</h1>
      <div className="mt-2 text-neutral-600">$90</div>

      <p className="mt-5 text-neutral-700">
        Clarity from your clips. We annotate moments, identify patterns, and build a
      ...
      <div className="mt-6">
        ...
        <ul className="mt-2 list-disc pl-5 space-y-1 text-neutral-700">
          <li>45–60 min review</li>
          <li>Strengths & growth opportunities</li>
          <li>Next-match action plan</li>
        </ul>
      </div>
