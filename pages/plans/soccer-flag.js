...
export default function SoccerFlag() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="mt-3 text-3xl font-extrabold">Soccer / Flag Football Hybrid (NEW)</h1>
      <div className="mt-2 text-neutral-600">$75</div>

      <p className="mt-5 text-neutral-700">
        Footwork + speed crossover for multi-sport athletes. Emphasis on agility, change of direction,
        and explosive first steps.
      </p>
      ...
      <div className="mt-6">
        ...
        <ul className="mt-2 list-disc pl-5 space-y-1 text-neutral-700">
          ...
          <li>Agility & change-of-direction</li>
          <li>Explosive first steps</li>
        </ul>
      </div>
...
// Reuse helpers (Payment/PayBox/PlayerForm)
