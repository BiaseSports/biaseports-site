// pages/plans/game-observation.js
import Link from "next/link";

export default function GameObservation() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      <Link href="/programs" className="text-sm underline">← Back to Programs</Link>
      <h1 className="mt-3 text-3xl font-extrabold">Game Observation</h1>
      <div className="mt-2 text-neutral-600">$60–90 + travel</div>

      <p className="mt-5 text-neutral-700">
        Coach eyes on your match + post-game debrief with 3 focus actions. Price depends on match length/level.
      </p>

      <div className="mt-6">
        <h2 className="font-semibold text-lg">What’s included</h2>
        <ul className="mt-2 list-disc pl-5 space-y-1 text-neutral-700">
          <li>Live notes on habits & decision patterns</li>
          <li>Optional timestamps if video is available</li>
          <li>Post-game debrief + 3 action items</li>
        </ul>
      </div>
      ...
      <section className="mt-10 rounded-2xl border border-neutral-200 p-5">
        ...
        <p className="mt-2 text-neutral-700">
          Pay via <strong>Zelle</strong> or <strong>Venmo</strong>. Travel fees are invoiced separately based on location.
        </p>
        ...
        <p className="mt-4 text-sm text-neutral-600">
          <strong>Important:</strong> Slot is <u>not reserved</u> until payment is received and travel is confirmed.
        </p>
      </section>
