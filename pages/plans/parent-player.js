...
export default function ParentPlayer() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="mt-3 text-3xl font-extrabold">Parent/Player Session (NEW)</h1>
      <div className="mt-2 text-neutral-600">$100</div>

      <p className="mt-5 text-neutral-700">
        Build skills together with joint drills, communication, and at-home routines.
        Make training a team sport at home.
      </p>
      ...
      <div className="mt-6">
        ...
        <ul className="mt-2 list-disc pl-5 space-y-1 text-neutral-700">
          ...
          <li>Parent & player together</li>
          <li>Fun competitive challenges</li>
        </ul>
      </div>
...
// Reuse helpers from above (Payment/PayBox/PlayerForm)
