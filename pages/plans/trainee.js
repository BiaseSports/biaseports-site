// pages/plans/trainee.js
import Link from "next/link";

export default function TraineePlan() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="mt-3 text-3xl font-extrabold">Trainee (Monthly) — Most Popular</h1>
      <div className="mt-2 text-neutral-600">$330 / month</div>

      <p className="mt-5 text-neutral-700">
        Acceleration phase with increased intensity, decision speed, and milestone tracking.
        Includes <strong>6 sessions per month</strong> plus <strong>game observation</strong>.
      </p>

      <div className="mt-6">
        <h2 className="font-semibold text-lg">What’s included</h2>
        <ul className="mt-2 list-disc pl-5 space-y-1 text-neutral-700">
          <li><strong>6 sessions per month</strong> + <strong>game observation</strong></li>
          <li>Advanced technical & tactical refinement</li>
          <li>Video feedback / film moments for review</li>
          <li>Milestones toward next Sock Level test</li>
        </ul>
      </div>
        ...
        <div className="mt-4 grid sm:grid-cols-2 gap-4">
          <div className="rounded-xl border p-4">
            ...
            <p className="mt-1 text-neutral-700">
              Send to:{" "}
              <a className="underline" href="tel:19492285477">
                <strong>949.228.5477</strong>
              </a>
            </p>
          </div>
          <div className="rounded-xl border p-4">
            ...
            <p className="mt-1 text-neutral-700">
              ...
              <a
                className="underline"
                href="https://venmo.com/u/umoh-edu"
                target="_blank"
      ...
      <section className="mt-10 rounded-2xl border border-neutral-200 p-5">
        ...
        <p className="mt-2 text-neutral-700">
          Fill out the form so we can tailor training to your goals.
        </p>
        <a
